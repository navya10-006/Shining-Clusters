...
var border,border2,border3,border4,border5,star,bgSongL,bgSong;
var wrong = 0;
var right = 0;
...
function preload(){
    ...
    //bgSongL = audio("Images/bg song.mp3");
}
...
function draw(){
    ...
    if(gameState === 5){
        ...
        fill("yellow")
        textSize(40);
        text("Well Done!! Your score is:"+score,windowWidth/2-300,windowHeight/2-60);
        question.title.hide();
        question.input.hide();
        question.button.hide();
        question.clueButton.hide();
        for(var i=0;i<=score;i++){
            for(var b=0;b<1000;b=b+80){
                var point = createSprite(600,400,20,20);
